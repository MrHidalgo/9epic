...
var mainSVGAnimation = function mainSVGAnimation() {
	...
	tweenAnimation1.fromTo('#laptop-top', 1, { opacity: 0, scale: 0.75, transformOrigin: 'center' }, { opacity: 1, scale: 1, ease: Power2.easeInnOut })
	// .fromTo('#laptop-border', 1, {opacity: 0}, {opacity: 1, ease: Power2.easeInnOut})
	.fromTo('#laptop-screen', 1, { opacity: 0 }, { opacity: 1, ease: Power2.easeInnOut }).fromTo('#laptop-shadow', 1, { opacity: 0, y: -5, scaleY: 0, transformOrigin: 'center' }, { opacity: 1, y: 0, scaleY: 1, ease: Power2.easeInnOut }, '-=1').fromTo('#laptop-line', 1, { opacity: 0 }, { opacity: 1, ease: Power2.easeInnOut }, '-=1').fromTo('#laptop-bottom', 1, { opacity: 0, y: -20, scaleX: 0.5, scaleY: 0, transformOrigin: 'center' }, { opacity: 1, y: 0, scaleX: 1, scaleY: 1, ease: Power2.easeInnOut }, '-=1').fromTo('#laptop-circle-1', 1.15, { opacity: 0, x: 30, scale: 0.75, transformOrigin: 'center' }, { opacity: 1, x: 0, scale: 1, ease: Power2.easeInnOut }).fromTo('#laptop-circle-2', 1.15, { opacity: 0, x: 30, scale: 0.75, transformOrigin: 'center' }, { opacity: 1, x: 0, scale: 1, ease: Power2.easeInnOut }, '-=0.25').fromTo('#laptop-circle-3', 1.15, { opacity: 0, x: 30, scale: 0.75, transformOrigin: 'center' }, { opacity: 1, x: 0, scale: 1, ease: Power2.easeInnOut }, '-=0.25').fromTo('#laptop-circle-4', 1.15, { opacity: 0, x: 30, scale: 0.75, transformOrigin: 'center' }, { opacity: 1, x: 0, scale: 1, ease: Power2.easeInnOut }, '-=0.25').fromTo('#laptop-circle-5', 1.15, { opacity: 0, x: 30, scale: 0.75, transformOrigin: 'center' }, { opacity: 1, x: 0, scale: 1, ease: Power2.easeInnOut }, '-=0.25');
	...
	vid1[0].addEventListener('ended', function (event) {
	...
	vid2[0].addEventListener('ended', function (event) {
	...
	vid3[0].addEventListener('ended', function (event) {
