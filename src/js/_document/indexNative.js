...
const homepageMainScrollAnimation =() => {
	...
	* ==================== */
	...
	tween1
		.set('#video1Wrapper video', {y: 0, transformOrigin: 'center'});
	...
	* ==================== */
	...
	tween2
		.set('#mainSVG1 svg', {y:0, transformOrigin: 'center'})
		.set(['#anim2-box-1', '#anim2-box-2', '#anim2-box-3', '#anim2-box-4', '#anim2-box-5'], {opacity: 0, x: 50, transformOrigin: '50%'})
		.set('#pc-top', {scaleY: 0, transformOrigin: 'center bottom'});
	
	tween2
		.to('#mainSVG1 svg', 1, {y: 149, ease: Linear.easeNone})
		.to('#pc-top', 0.05, {scaleY: 1, ease: Linear.easeNone}, '-=1')
		.to('#anim2-box-1', 0.1, {opacity: 1, x: 0, ease: Linear.easeNone}, '-=1')
		.to('#anim2-box-2', 0.1, {opacity: 1, x: 0, ease: Linear.easeNone}, '-=0.9')
		.to('#anim2-box-3', 0.1, {opacity: 1, x: 0, ease: Linear.easeNone}, '-=0.8')
		.to('#anim2-box-4', 0.1, {opacity: 1, x: 0, ease: Linear.easeNone}, '-=0.7')
		.to('#anim2-box-5', 0.1, {opacity: 1, x: 0, ease: Linear.easeNone}, '-=0.6')
	...
	* ==================== */
	...
	tween3
		.fromTo('#video2Wrapper', 0.01, {y: -400, scale: 0.8, transformOrigin: 'center'}, {y: -50, scale: 1, ease: Linear.easeNone})
		.fromTo('#video2Wrapper', 0.001, {opacity: 0}, {opacity: 1, ease: Linear.easeNone}, '-=0.01')
		.to('#video2Wrapper', 0.001, {opacity: 0, scale: 0.75, rotation: 45, ease: Linear.easeNone}, '-=0.001');
	...
	* ==================== */
	...
	tween4
		.fromTo('#mainSVG2', 0.1, {opacity: 0}, {opacity: 1, ease: Linear.easeNone})
		.fromTo('#mainSVG2 svg', 2, {y: -200}, {y: 200, ease: Linear.easeNone}, '-=0.1')
		.fromTo('#anim4-bg', 2, {rotation: 0, transformOrigin: 'center'}, {rotation: 360, ease: Linear.easeNone}, '-=2')
		.fromTo('#anim4-box-1', 0.5, {opacity: 0, scale: 0.5, transformOrigin: '460px 350px'}, {opacity: 1, scale: 1, ease: Linear.easeNone}, '-=2')
		.fromTo('#anim4-box-2', 0.5, {opacity: 0, scale: 0.5, transformOrigin: '40px 350px'}, {opacity: 1, scale: 1, ease: Linear.easeNone}, '-=1.9')
		.fromTo('#anim4-box-3', 0.5, {opacity: 0, scale: 0.5, transformOrigin: '-380px 350px'}, {opacity: 1, scale: 1, ease: Linear.easeNone}, '-=1.8')
		.fromTo('#anim4-box-4', 0.5, {opacity: 0, scale: 0.5, transformOrigin: '560px -70px'}, {opacity: 1, scale: 1, ease: Linear.easeNone}, '-=1.7')
		.fromTo('#anim4-box-5', 0.5, {opacity: 0, scale: 0.5, transformOrigin: '140px -70px'}, {opacity: 1, scale: 1, ease: Linear.easeNone}, '-=1.6')
		.fromTo('#anim4-box-6', 0.5, {opacity: 0, scale: 0.5, transformOrigin: '-280px -70px'}, {opacity: 1, scale: 1, ease: Linear.easeNone}, '-=1.5')
		.to('#mainSVG2 svg', 0.001, {opacity: 0, ease: Linear.easeNone}, '-=0.001');
	...
	* ==================== */
	...
	tween5
		.fromTo('#video3Wrapper', 0.01, {y: -400, scale: 0.85, transformOrigin: 'center'}, {y: -50, scale: 1, ease: Linear.easeNone})
		.fromTo('#video3Wrapper', 0.001, {opacity: 0}, {opacity: 1, ease: Linear.easeNone}, '-=0.01');
